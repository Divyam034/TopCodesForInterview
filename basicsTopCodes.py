...
# Python program to check whether two numbers are friendly pair or not
# First of all we will create some test cases
...
for i in range(len(tests)):
    print(is_friendlypair(tests[i]["input"]["num1"],tests[i]["input"]["num2"] )== tests[i]["output"])
